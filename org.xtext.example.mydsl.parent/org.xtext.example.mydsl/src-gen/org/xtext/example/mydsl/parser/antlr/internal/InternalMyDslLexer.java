...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_TYPE() throws RecognitionException {
        try {
            int _type = RULE_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:309:11: ( ( 'ouvrir url' | 'saisir identifiant' | 'saisir mot de passe' | 'clic id=' | 'naviguer' | 'verifier id=' ) )
            // InternalMyDsl.g:309:13: ( 'ouvrir url' | 'saisir identifiant' | 'saisir mot de passe' | 'clic id=' | 'naviguer' | 'verifier id=' )
            {
            // InternalMyDsl.g:309:13: ( 'ouvrir url' | 'saisir identifiant' | 'saisir mot de passe' | 'clic id=' | 'naviguer' | 'verifier id=' )
            int alt1=6;
            ...
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:309:14: 'ouvrir url'
                    {
                    match("ouvrir url"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:309:27: 'saisir identifiant'
                    {
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:309:48: 'saisir mot de passe'
                    {
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:309:70: 'clic id='
                    {
                    match("clic id="); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:309:81: 'naviguer'
                    {
                    match("naviguer"); 
                    ...
                    break;
                case 6 :
                    // InternalMyDsl.g:309:92: 'verifier id='
                    {
                    match("verifier id="); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:311:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:311:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:311:11: ( '^' )?
            int alt2=2;
            ...
            // InternalMyDsl.g:311:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:313:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:313:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:313:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:315:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:315:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:315:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalMyDsl.g:315:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:315:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:315:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:315:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:317:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:317:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:317:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:319:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:319:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:319:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:321:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:321:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:321:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:323:16: ( . )
            // InternalMyDsl.g:323:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "309:13: ( 'ouvrir url' | 'saisir identifiant' | 'saisir mot de passe' | 'clic id=' | 'naviguer' | 'verifier id=' )";
        }
    }
